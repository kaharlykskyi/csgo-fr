...
class ForumController extends Controller
{
    ...
    public function topicPage(Request $request){
        ...
        $affix_threads = TopicThread::where('topic_id',$topic->id)->whereIn('state',[2])->orderBy('created_at', 'desc')->limit(3);
        $users_id = [];
    ...
    public function threadPost(Request $request){
        ...
        $posts = ThreadPost::with('children')->where('parent_post')->paginate(10);
        $users_id = [];
