...
trait MatchSort
{
    ...
    public function selectMatch(){
        ...
        $live_match = Match::whereRaw("(TIMESTAMPDIFF(MINUTE, match_day, CURRENT_TIMESTAMP) < 120) AND (TIMESTAMPDIFF(MINUTE, NOW(), match_day) < 60)")->limit((int)$count_live_match_scoreboard->value)->get();
