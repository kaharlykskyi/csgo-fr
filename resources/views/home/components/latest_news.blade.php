    ...
    <div class="nk-news-box-list">
        <div class="nano">
            <div class="nano-content">
                ...
                <div class="nk-news-box-item">
                    <div class="nk-news-box-item-img">
                        <img src="{{ asset('images/post-3-sm.jpg') }}" alt="We found a witch! May we burn her?">
                    </div>
                    <img src="{{ asset('images/post-3.jpg') }}" alt="We found a witch! May we burn her?" class="nk-news-box-item-full-img">
                ...
                <div class="nk-news-box-item">
                    <div class="nk-news-box-item-img">
                        <img src="{{ asset('images/post-4-sm.jpg') }}" alt="For good, too though, in consequence">
                    </div>
                    <img src="{{ asset('images/post-4.jpg') }}" alt="For good, too though, in consequence" class="nk-news-box-item-full-img">
                ...
                <div class="nk-news-box-item">
                    <div class="nk-news-box-item-img">
                        <img src="{{ asset('images/post-5-sm.jpg') }}" alt="He made his passenger captain of one">
                    </div>
                    <img src="{{ asset('images/post-5.jpg') }}" alt="He made his passenger captain of one" class="nk-news-box-item-full-img">
                ...
                <div class="nk-news-box-item">
                    <div class="nk-news-box-item-img">
                        <img src="{{ asset('images/post-6-sm.jpg') }}" alt="At first, for some time, I was not able to answer">
                    </div>
                    <img src="{{ asset('images/post-6.jpg') }}" alt="At first, for some time, I was not able to answer" class="nk-news-box-item-full-img">
