...
<div class="row vertical-gap">
    ...
    <div class="col-md-6">
        <div class="nk-product-cat">
            <a class="nk-product-image" href="store-product.html">
                <img src="{{ asset('images/product-11-xs.jpg') }}" alt="She gave my mother">
            </a>
    ...
    <div class="col-md-6">
        <div class="nk-product-cat">
            <a class="nk-product-image" href="store-product.html">
                <img src="{{ asset('images/product-12-xs.jpg') }}" alt="A hundred thousand">
            </a>
            <div class="nk-product-cont">
    ...
    <div class="col-md-6">
        <div class="nk-product-cat">
            <a class="nk-product-image" href="store-product.html">
                <img src="{{ asset('images/product-13-xs.jpg') }}" alt="So saying he unbuckled">
            </a>
            <div class="nk-product-cont">
    ...
    <div class="col-md-6">
        <div class="nk-product-cat">
            <a class="nk-product-image" href="store-product.html">
                <img src="{{ asset('images/product-14-xs.jpg') }}" alt="However, I have reason">
            </a>
            <div class="nk-product-cont">
