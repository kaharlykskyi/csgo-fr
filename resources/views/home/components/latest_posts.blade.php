...
<div class="nk-blog-grid">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="nk-blog-post">
                <a href="blog-article.html" class="nk-post-img">
                    <img src="{{ asset('images/post-5-mid.jpg') }}" alt="He made his passenger captain of one">
                ...
                <div class="nk-post-by">
                    <img src="{{ asset('images/avatar-3.jpg') }}" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="https://nkdev.info">Wolfenstein</a> in Jul 23, 2018
                </div>
                <div class="nk-gap"></div>
        ...
        <div class="col-md-6">
            ...
            <div class="nk-blog-post">
                <a href="blog-article.html" class="nk-post-img">
                    <img src="{{ asset('images/post-6-mid.jpg') }}" alt="At first, for some time, I was not able to answer">
                ...
                <div class="nk-post-by">
                    <img src="{{ asset('images/avatar-3.jpg') }}" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="https://nkdev.info">Wolfenstein</a> in Jul 3, 2018
                </div>
                <div class="nk-gap"></div>
                <div class="nk-post-text">
